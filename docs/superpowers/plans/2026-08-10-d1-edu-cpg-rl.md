...
- CPG 常數：`MU_MIN=1.0, MU_MAX=2.0, OMEGA_MIN=0.0, OMEGA_MAX=4.5, A_CONV=50.0, D_STEP=0.12, G_C=0.08, G_P=0.01, W_COUP=8.0, N_CPG_SUB=4`。
...
class D1wCpgEnv(Env):
    ...
    def step(self, state, action):
        ...
        r_h = jnp.exp(-40.0 * (data.qpos[2] - self._init_q[2]) ** 2)
