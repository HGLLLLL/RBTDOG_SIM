...
| 輪幾何 | 半徑 **0.0710 m**、寬 0.0480 m、圓盤中心在 FOOT 座標系 `(0, ±0.04488, 0)` | STL 實測 + URDF 慣量原點 |
| 視覺 | 原 STL | — |
...
| home keyframe | 關節 `[0, +1.05, −2.00] × 4`；機身 z ≈ 0.2948 m | 見 3.5 |
...
| 9 | `D_STEP`/`G_C` | 0.12 / 0.08 | 先維持原值 | 關卡 3 實測校正 |
