...
CASES = (("直走 0.5", (0.5, 0.0, 0.0), "fwd"), ("弧線 0.5+0.5", (0.5, 0.0, 0.5), "arc"), ("原地左轉 1.3", (0.0, 0.0, 1.3), "turn"),
         ("原地右轉 1.3", (0.0, 0.0, -1.3), "turn"), ("左平移 0.08", (0.0, 0.08, 0.0), "lat"), ("右平移 0.08", (0.0, -0.08, 0.0), "lat"),
         ("左平移 0.04", (0.0, 0.04, 0.0), "lat"), ("斜走 0.3+0.06", (0.3, 0.06, 0.0), "diag"), ("站立", (0.0, 0.0, 0.0), "stand"))
