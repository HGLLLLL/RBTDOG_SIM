...
#    微動測試不要挑這個關節，方向也不能亂選。
#
# ⚠️ knee 這裡用 MJCF 的 ±2.791。實機癱平時膝頂在 ±2.80 的機械停點（與 URDF 的
#    ±2.801 相符），所以 MJCF 略緊 0.01 rad。**保持略緊是安全的**，不要放寬。
LIMITS = {
    ...
    "fr" + KIND_KNEE:      (-2.791, 2.791),
    "fl" + KIND_KNEE:      (-2.791, 2.791),
    "br" + KIND_KNEE:      (-2.791, 2.791),
    "bl" + KIND_KNEE:      (-2.791, 2.791),
}
